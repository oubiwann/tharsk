...
PIP ?= pip-2.7
PYTHON ?= python2.7
TWISTD ?= /System/Library/Frameworks/Python.framework/Versions/2.7/Extras/bin/twistd
TRIAL ?= /System/Library/Frameworks/Python.framework/Versions/2.7/Extras/bin/trial
LESSC ?= $(BIN_DIR)/lessc
